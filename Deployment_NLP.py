...
def main():
    ...
    option = st.sidebar.selectbox('Menu bar',['Key attributes','Sentiment Analysis',])

    if option == "Key attributes":

        if st.button("Key attributes"):
        ...
        if st.button("Sentiment Analysis"):
            ...
            if score.sentiment.polarity <0:
                ...
                result_sentiment = score.sentiment
